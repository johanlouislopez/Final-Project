...
public class VolcanicEruption extends JFrame {

    public VolcanicEruption() {

        setTitle("Volcanic Eruption Safety Guide");
        ...
        volcano.setForeground(Color.WHITE);
        volcano.setFont(new Font("SansSerif", Font.BOLD, 18));
        iconPanel.add(volcano);

        JPanel textPanel = new JPanel();
        textPanel.setOpaque(false);
        textPanel.setLayout(new BoxLayout(textPanel, BoxLayout.Y_AXIS));

        JLabel title = new JLabel("Volcanic Eruption Safety");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        // SUBTITLE RED
        JLabel subtitle = new JLabel("⚠ Evacuate immediately when ordered by authorities!");
        ...
        addStep(stepsPanel, "1", "Follow Evacuation Orders",
                "Leave dangerous areas immediately when instructed.");

        addStep(stepsPanel, "2", "Wear Protection",
                "Use masks, goggles, and long sleeves against ash.");

        addStep(stepsPanel, "3", "Stay Indoors if Needed",
                "Close windows and doors to keep ash outside.");

        addStep(stepsPanel, "4", "Avoid River Channels",
                "Stay away from rivers where lava and mudflows may occur.");

        addStep(stepsPanel, "5", "Prepare Emergency Supplies",
                "Bring water, food, medicine, and flashlights.");

        addStep(stepsPanel, "6", "Listen to Authorities",
        ...
        addBullet(tipsPanel, "Keep emergency bags ready at all times");
        addBullet(tipsPanel, "Cover water containers from ash fall");
        addBullet(tipsPanel, "Charge communication devices early");
        ...
        addBullet(warningPanel, "Do not go near the volcano crater");
        addBullet(warningPanel, "Avoid driving during heavy ash fall");
        addBullet(warningPanel, "Do not ignore evacuation warnings");
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        // ORANGE COLOR
        number.setBackground(new Color(255, 165, 0));
