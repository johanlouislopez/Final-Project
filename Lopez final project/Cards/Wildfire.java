...
public class Wildfire extends JFrame {

    public Wildfire() {

        setTitle("Wildfire Safety Guide");
        ...
        // RED COLOR
        iconPanel.setBackground(new Color(255, 0, 0));

        iconPanel.setPreferredSize(new Dimension(40, 40));

        JLabel fire = new JLabel("🔥");
        fire.setForeground(Color.WHITE);
        fire.setFont(new Font("SansSerif", Font.BOLD, 18));
        iconPanel.add(fire);
        ...
        JLabel title = new JLabel("Wildfire Safety");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        // SUBTITLE RED
        JLabel subtitle = new JLabel("⚠ Evacuate immediately if wildfire approaches!");
        ...
        addStep(stepsPanel, "1", "Evacuate Early",
                "Leave the area immediately when advised by authorities.");

        addStep(stepsPanel, "2", "Wear Protective Clothing",
                "Use masks, goggles, and long sleeves for protection.");

        addStep(stepsPanel, "3", "Close Windows and Doors",
                "Prevent smoke and embers from entering your home.");

        addStep(stepsPanel, "4", "Prepare Emergency Supplies",
                "Bring water, food, medicine, and important documents.");

        addStep(stepsPanel, "5", "Avoid Smoke Exposure",
                "Stay away from thick smoke to protect your lungs.");

        addStep(stepsPanel, "6", "Follow Emergency Updates",
                "Listen to official announcements and evacuation routes.");
        ...
        addBullet(tipsPanel, "Keep emergency bags ready");
        addBullet(tipsPanel, "Charge phones and flashlights");
        addBullet(tipsPanel, "Know multiple evacuation routes");
        ...
        addBullet(warningPanel, "Do not stay behind to protect property");
        addBullet(warningPanel, "Avoid driving through heavy smoke");
        addBullet(warningPanel, "Stay away from burning vegetation");
