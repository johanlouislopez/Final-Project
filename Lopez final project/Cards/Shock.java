...
public class Shock extends JFrame {

    public Shock() {

        setTitle("Shock Guide");
        ...
        iconPanel.setBackground(new Color(255, 193, 7)); // YELLOW BOX
        ...
        JLabel title = new JLabel("Shock Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        // REQUIRED: subtitle RED
        JLabel subtitle = new JLabel("⚠️ Lay the person down and seek emergency help immediately");
        ...
        addStep(stepsPanel, "2", "Lay Person Flat",
                "Keep the person lying down on their back.");

        addStep(stepsPanel, "3", "Elevate Legs",
                "Raise legs slightly unless injury is suspected.");

        addStep(stepsPanel, "4", "Keep Warm",
                "Cover with a blanket to maintain body heat.");

        addStep(stepsPanel, "5", "Do NOT Give Food or Drink",
                "Avoid giving anything by mouth.");

        addStep(stepsPanel, "6", "Monitor Breathing",
                "Check breathing and responsiveness continuously.");
        ...
        addBullet(tipsPanel, "Stay calm and reassure the person");
        addBullet(tipsPanel, "Keep airway open");
        addBullet(tipsPanel, "Loosen tight clothing");
        ...
        addBullet(warningPanel, "Do not give food or drink");
        addBullet(warningPanel, "Do not move if spinal injury suspected");
        addBullet(warningPanel, "Shock is life-threatening — act fast");
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        number.setBackground(new Color(255, 193, 7));
