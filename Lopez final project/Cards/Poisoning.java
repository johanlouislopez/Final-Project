...
public class Poisoning extends JFrame {

    public Poisoning() {

        setTitle("Poisoning Guide");
        ...
        iconPanel.setBackground(new Color(186, 85, 211)); // PURPLE THEME
        ...
        JLabel title = new JLabel("Poisoning Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        // 🔴 REQUIRED: subtitle is RED
        JLabel subtitle = new JLabel("⚠️ Call emergency help immediately and avoid further exposure");
        ...
        addStep(stepsPanel, "1", "Call Emergency Help",
                "Contact emergency services immediately.");

        addStep(stepsPanel, "2", "Identify Poison",
                "Try to identify the substance if safe.");

        addStep(stepsPanel, "3", "Remove Exposure",
                "Move the person away from the source.");

        addStep(stepsPanel, "4", "Do NOT Induce Vomiting",
                "Unless instructed by professionals.");

        addStep(stepsPanel, "5", "Rinse If Needed",
                "Wash affected skin or eyes with clean water.");

        addStep(stepsPanel, "6", "Monitor Condition",
        ...
        addBullet(tipsPanel, "Keep poison container for identification");
        addBullet(tipsPanel, "Stay calm and act quickly");
        addBullet(tipsPanel, "Avoid giving food or drink unless advised");
        ...
        addBullet(warningPanel, "Do not induce vomiting unless told");
        addBullet(warningPanel, "Do not ignore symptoms");
        addBullet(warningPanel, "Do not delay emergency treatment");
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        number.setBackground(new Color(186, 85, 211)); // PURPLE THEME
