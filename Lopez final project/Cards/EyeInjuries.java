...
public class EyeInjuries extends JFrame {

    public EyeInjuries() {

        setTitle("Eye Injuries Guide");
        ...
        iconPanel.setBackground(new Color(0, 255, 0)); // GREEN THEME
        ...
        JLabel title = new JLabel("Eye Injuries Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        JLabel subtitle = new JLabel("⚠️ Handle eyes carefully to prevent permanent damage");
        ...
        addStep(stepsPanel, "1", "Do Not Rub Eye",
                "Avoid touching or rubbing the injured eye.");

        addStep(stepsPanel, "2", "Wash Hands",
                "Clean your hands before assisting the eye.");

        addStep(stepsPanel, "3", "Rinse Gently",
                "Use clean water to flush the eye if needed.");

        addStep(stepsPanel, "4", "Remove Contact Lenses",
                "If present and easy to remove, take them out.");

        addStep(stepsPanel, "5", "Cover Eye",
                "Use a clean cloth or eye shield to protect it.");

        addStep(stepsPanel, "6", "Seek Medical Help",
                "Go to a hospital immediately for serious injuries.");
        ...
        addBullet(tipsPanel, "Do not apply pressure on the eye");
        addBullet(tipsPanel, "Avoid using chemicals or drops unless instructed");
        ...
        addBullet(warningPanel, "Never try to remove embedded objects");
        addBullet(warningPanel, "Do not rub or press the eye");
        addBullet(warningPanel, "Avoid delaying medical treatment");

        mainPanel.add(warningPanel);
        mainPanel.add(Box.createVerticalStrut(20));

        // EMERGENCY BUTTON (RED ONLY AS REQUESTED)
        JButton emergencyBtn = new JButton(
                "<html><center>In case of emergency:<br><b>View Nearest Hospitals</b></center></html>"
        );

        emergencyBtn.setBackground(new Color(255, 0, 0)); // RED ONLY HERE
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        number.setBackground(new Color(0, 255, 0)); // GREEN THEME
