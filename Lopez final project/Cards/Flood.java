...
public class Flood extends JFrame {
    ...
    public Flood() {
        ...
        JLabel title = new JLabel("Flood Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        JLabel subtitle = new JLabel("⚠️ Move to higher ground immediately and stay safe");
        ...
        addStep(stepsPanel, "1", "Move to Higher Ground",
                "Go to elevated areas immediately.");

        addStep(stepsPanel, "2", "Turn Off Electricity",
                "Avoid electrical hazards if safe to do so.");

        addStep(stepsPanel, "3", "Avoid Floodwater",
                "Do not walk or drive through moving water.");

        addStep(stepsPanel, "4", "Listen to Updates",
                "Follow news and emergency alerts.");

        addStep(stepsPanel, "5", "Prepare Emergency Kit",
                "Bring water, food, flashlight, and essentials.");

        addStep(stepsPanel, "6", "Evacuate if Needed",
                "Leave early before conditions worsen.");
        ...
        addBullet(tipsPanel, "Keep emergency supplies ready");
        addBullet(tipsPanel, "Stay away from rivers and drains");
        addBullet(tipsPanel, "Charge mobile devices early");
        ...
        addBullet(warningPanel, "Never enter floodwater");
        addBullet(warningPanel, "Avoid bridges during floods");
        addBullet(warningPanel, "Do not ignore evacuation orders");

        mainPanel.add(warningPanel);
        mainPanel.add(Box.createVerticalStrut(20));

        // EMERGENCY BUTTON (RED REQUIRED)
