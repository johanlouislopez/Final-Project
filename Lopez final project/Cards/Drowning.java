...
public class Drowning extends JFrame {

    public Drowning() {

        setTitle("Drowning Guide");
        ...
        iconPanel.setBackground(new Color(0, 0, 255)); // BLUE THEME
        ...
        JLabel title = new JLabel("Drowning Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        JLabel subtitle = new JLabel("🚨 Act quickly and safely to save a life");
        ...
        addStep(stepsPanel, "1", "Ensure Scene Safety",
                "Make sure you are safe before attempting rescue.");

        addStep(stepsPanel, "2", "Call Emergency Help",
                "Call 911 or ask someone to call immediately.");

        addStep(stepsPanel, "3", "Remove from Water",
                "Bring the person out of the water as quickly as possible.");

        addStep(stepsPanel, "4", "Check Breathing",
                "Look for breathing and responsiveness.");

        addStep(stepsPanel, "5", "Start CPR if Needed",
                "Begin CPR if the person is not breathing.");

        addStep(stepsPanel, "6", "Keep Monitoring",
        ...
        addBullet(tipsPanel, "Only attempt rescue if it is safe");
        addBullet(tipsPanel, "Use floatation if available");
        addBullet(tipsPanel, "Perform CPR immediately if trained");
        ...
        addBullet(warningPanel, "Do not jump into water if unsafe");
        addBullet(warningPanel, "Avoid panicking the victim further");
        addBullet(warningPanel, "Do not delay calling emergency services");
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        number.setBackground(new Color(0, 0, 255)); // BLUE THEME
