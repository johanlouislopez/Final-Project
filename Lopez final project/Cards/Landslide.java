...
public class Landslide extends JFrame {

    public Landslide() {

        setTitle("Landslide Guide");
        ...
        iconPanel.setBackground(new Color(45, 45, 45)); // DARK THEME
        ...
        JLabel title = new JLabel("Landslide Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        // 🔴 REQUIRED: subtitle is RED
        JLabel subtitle = new JLabel("⚠️ Move away from slopes and unstable ground immediately");
        ...
        addStep(stepsPanel, "1", "Move Away Immediately",
                "Get away from slopes, cliffs, and unstable ground.");

        addStep(stepsPanel, "2", "Go to Higher Ground",
                "Move uphill or to stable areas if safe.");

        addStep(stepsPanel, "3", "Avoid River Channels",
                "Stay away from rivers and drainage paths.");

        addStep(stepsPanel, "4", "Protect Head",
                "Cover your head with arms or objects.");

        addStep(stepsPanel, "5", "Stay Alert",
                "Watch for further movement or afterslides.");

        addStep(stepsPanel, "6", "Call Emergency Help",
        ...
        addBullet(tipsPanel, "Stay away from steep slopes during heavy rain");
        addBullet(tipsPanel, "Follow evacuation warnings immediately");
        addBullet(tipsPanel, "Prepare emergency kit in advance");
        ...
        addBullet(warningPanel, "Do not stay in landslide-prone areas");
        addBullet(warningPanel, "Avoid crossing muddy or unstable ground");
        addBullet(warningPanel, "Do not ignore evacuation orders");
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        number.setBackground(new Color(45, 45, 45)); // DARK THEME
