...
public class HeatStroke extends JFrame {

    public HeatStroke() {

        setTitle("Heat Stroke Guide");
        ...
        JLabel title = new JLabel("Heat Stroke Emergency");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        // 🔴 REQUIRED: subtitle is RED
        JLabel subtitle = new JLabel("⚠️ Move to a cool place and reduce body temperature immediately");
        ...
        addStep(stepsPanel, "1", "Move to Shade",
                "Immediately go to a cool or shaded area.");

        addStep(stepsPanel, "2", "Remove Excess Clothing",
                "Loosen or remove tight clothing.");

        addStep(stepsPanel, "3", "Cool the Body",
                "Apply cold water, ice packs, or wet cloths.");

        addStep(stepsPanel, "4", "Hydrate",
                "Drink cool water slowly if conscious.");

        addStep(stepsPanel, "5", "Fan the Person",
                "Increase airflow to reduce body heat.");
        ...
        addBullet(tipsPanel, "Avoid direct sun exposure");
        addBullet(tipsPanel, "Drink water regularly in hot weather");
        addBullet(tipsPanel, "Wear light-colored clothing");
        ...
        addBullet(warningPanel, "Do not ignore confusion or dizziness");
        addBullet(warningPanel, "Do not give fluids if unconscious");
        addBullet(warningPanel, "Do not delay medical treatment");
