...
public class CPR extends JFrame {
    ...
    public CPR() {
        ...
        iconPanel.setBackground(new Color(255, 59, 59));
        iconPanel.setPreferredSize(new Dimension(40, 40));

        JLabel heart = new JLabel("❤");
        heart.setForeground(Color.WHITE);
        heart.setFont(new Font("SansSerif", Font.BOLD, 18));
        iconPanel.add(heart);
        ...
        JLabel title = new JLabel("CPR & Cardiac Arrest");
        title.setFont(new Font("SansSerif", Font.BOLD, 16));

        JLabel subtitle = new JLabel("📞 Call 911 or nearest ambulance immediately!");
        ...
        addStep(stepsPanel, "1", "Check Responsiveness",
                "Tap the victim’s shoulder and ask 'Are you okay?'.");

        addStep(stepsPanel, "2", "Position the Victim",
                "Lay the victim on a hard, flat surface.");

        addStep(stepsPanel, "3", "Open Airway",
                "Tilt the head back slightly and check the mouth.");

        addStep(stepsPanel, "4", "Chest Compressions",
                "Push hard and fast in the center of the chest.");

        addStep(stepsPanel, "5", "Rescue Breaths",
                "Give 2 rescue breaths after 30 compressions.");

        addStep(stepsPanel, "6", "Repeat Cycles",
        ...
        addBullet(tipsPanel, "Don't stop CPR until medical help arrives");
        addBullet(tipsPanel, "Take turns with another person if possible");
        addBullet(tipsPanel, "If untrained, perform chest compressions only");
        ...
        addBullet(warningPanel, "CPR can break ribs — this is normal");
        addBullet(warningPanel, "Don't move the victim unless unsafe");
        addBullet(warningPanel, "Always call medical help first");

        mainPanel.add(warningPanel);
        mainPanel.add(Box.createVerticalStrut(20));

        // EMERGENCY BUTTON (UPDATED)
    ...
    static void addStep(JPanel parent, String num, String title, String desc) {
        ...
        number.setBackground(new Color(255, 0, 50));
